...
export function Footer() {
  ...
  return (
    <footer className="bg-background border-t border-border theme-transition">
      <div className="container max-w-[500px] mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="block">
              <div className="relative w-[350px] h-[150px]">
                <Image 
                  src="/images/thinkbuild-logo.png" 
                  alt="ThinkBuild Logo" 
                  fill
            ...
            <div className="flex gap-3">
              <a 
                href="#" 
                className="bg-background border border-border rounded-full p-2 hover:border-primary transition-colors"
                aria-label="Facebook"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className="w-4 h-4 text-foreground/70">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/contact-us" className="text-foreground/70 hover:text-primary transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-6 border-t border-border text-center">
          <p className="text-xs text-foreground/60">
            © {currentYear} ThinkBuild. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
