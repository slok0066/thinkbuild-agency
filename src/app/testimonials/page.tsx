...
export const metadata: Metadata = {
  title: "Testimonials | ThinkBuild",
  description: "What our clients say about our services and solutions.",
};
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="bg-background border border-border rounded-lg p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/60">CEO, InnovateTech Solutions</p>
            </div>
          </div>
          <div className="mb-4">
        ...
        <div className="bg-background border border-border rounded-lg p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/60">Marketing Director, Nexus Digital</p>
            </div>
          </div>
          <div className="mb-4">
            <div className="flex text-amber-400">
        ...
        <div className="bg-background border border-border rounded-lg p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/60">Founder, Artisan Crafts India</p>
            </div>
          </div>
          <div className="mb-4">
            <div className="flex text-amber-400">
        ...
        <div className="bg-background border border-border rounded-lg p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/60">CTO, FinTech Innovations</p>
            </div>
          </div>
          <div className="mb-4">
            <div className="flex text-amber-400">
        ...
        <div className="bg-background border border-border rounded-lg p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/60">Director, EduTech Academy</p>
            </div>
          </div>
          <div className="mb-4">
            <div className="flex text-amber-400">
        ...
        <div className="bg-background border border-border rounded-lg p-6 shadow-sm">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h3 className="font-semibold">Neha Reddy</h3>
              <p className="text-sm text-foreground/60">CEO, HealthPlus Solutions</p>
            </div>
          </div>
          <div className="mb-4">
            <div className="flex text-amber-400">
